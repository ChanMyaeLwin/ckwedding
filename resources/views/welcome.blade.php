...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>C & K - Wedding Invitation</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="C & K - Wedding Invitation" />
	<meta name="keywords" content="C & K, Wedding, Invoice" />
    ...
    *:after{
	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container">
			<div class="row">
				<div class="col-xs-2">
					<div id="fh5co-logo"><a href="{{ route('welcome') }}" >C &amp; K</a></div>
				</div>
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
                            ...
                            <p><a target="_blank" href="https://calendar.google.com/event?action=TEMPLATE&amp;tmeid=MDJiZm5zZjMwcmRlczZ1cmsxbmg1dmthc3EgbHdpbi5jaGFubXlhZTRAbQ&amp;tmsrc=lwin.chanmyae4%40gmail.com" class="btn btn-default btn-sm">Save the date</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<h2>Hello!</h2>
					<h3>December 25th, 2022</h3>
					<h3>Yangon, 9 Miles Shan Monastery</h3>
	...
	<div id="fh5co-event" class="fh5co-bg" style="background-image:url({{asset('images/img_bg_3.jpg')}});">
		<div class="overlay"></div>
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<div class="fh5co-video fh5co-bg" style="background-image: url({{asset('images/img_bg_3.jpg')}}); ">
    ...
    <div class="popup">
        ...
        <h2>Thank You</h2>
        <p>
            Thank you, {{$username}} for Visit Our Website
        </p>
    </div>
	<!-- jQuery -->
