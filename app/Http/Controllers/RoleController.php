...
class RoleController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        'document_attach','document_export','document_update','product_permission','user_permission','role_permission','supplier_permission','branch_permission','my_document'));
        // }catch (\Exception $e) {
        //     Log::debug($e->getMessage());
        //     return redirect()
    ...
    public function edit($id)
    {
        try{
            ...
            'document_attach','document_export','document_update','product_permission','user_permission','role_permission','supplier_permission','branch_permission','my_document','rolePermissions'));
        }catch (\Exception $e) {
            Log::debug($e->getMessage());
            return redirect()
                ->intended(route("roles.index"))
