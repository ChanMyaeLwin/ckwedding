...
class DocumentController extends Controller
{
        ...
        try {
            ...
            if ($detail_type == 6) {
                if(Gate::allows('my-document-operation')){
                    $result = $result->whereOr('document_status', 1)
                ...
                elseif (Gate::allows('my-document-ch')) {
                    $result = $result->whereOr('document_status', 2);
                }
                elseif (Gate::allows('my-document-mm')) {
                    $result = $result->whereOr('document_status', 4);
                }
                elseif (Gate::allows('my-document-rgout')) {
                    $result = $result->whereOr('document_status', 6);
                }
                elseif (Gate::allows('my-document-account-cn')) {
                    $result = $result->whereOr('document_status', 8);
                }
                elseif (Gate::allows('my-document-rgin')) {
                    $result = $result->whereOr('document_status', 9);
                }
                elseif (Gate::allows('my-document-account-db')) {
                    $result = $result->whereOr('document_status', 10);
                }
            }
    ...
    public function change_to_previous_status(Request $request)
    {
        try {
            ...
            if(Gate::allows('update-document-ch-complete') && $document_status == 4){
            ...
            if(Gate::allows('update-document-mm-complete') && $document_status == 6){
